...
public class ReportLostElectronicScreen extends JFrame {

    public ReportLostElectronicScreen() {
        // The Window
        setTitle("Report Lost Electronic Device");
        setSize(420, 370);
        ...
        submitButton.addActionListener(e -> {
            ...
            ElectronicDevice lostDevice = new ElectronicDevice(
                    0,
                    "Device",
            ...
            NetworkRequest request = new NetworkRequest("REPORT_LOST", lostDevice);
